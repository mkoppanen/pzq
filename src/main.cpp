...
int main (int argc, char *argv []) 
{
    ...
    pzq::device_t *receiver = new pzq::device_t;
    pzq::device_t *sender   = new pzq::device_t;
    ...
    // move the context termination to detached thread
    pzq::terminator_t terminator (context);
    terminator.start ();
